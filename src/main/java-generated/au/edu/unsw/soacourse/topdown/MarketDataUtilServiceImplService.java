 ...
 * 2015-04-18T23:04:54.226+10:00
 * Generated source version: 3.0.4
 * 
 */
@WebServiceClient(name = "MarketDataUtilServiceImplService", 
                  wsdlLocation = "http://localhost:8080/Assignment1/MarketDataUtilService?wsdl",
                  targetNamespace = "http://topdown.soacourse.unsw.edu.au/") 
public class MarketDataUtilServiceImplService extends Service {

    public final static URL WSDL_LOCATION;

    public final static QName SERVICE = new QName("http://topdown.soacourse.unsw.edu.au/", "MarketDataUtilServiceImplService");
    public final static QName MarketDataUtilServiceImplPort = new QName("http://topdown.soacourse.unsw.edu.au/", "MarketDataUtilServiceImplPort");
    static {
        URL url = null;
        try {
            url = new URL("http://localhost:8080/Assignment1/MarketDataUtilService?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(MarketDataUtilServiceImplService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "http://localhost:8080/Assignment1/MarketDataUtilService?wsdl");
        }
        WSDL_LOCATION = url;
    }
